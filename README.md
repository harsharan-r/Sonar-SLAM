# Sonar-SLAM
A lightweight learning project that implements basic SLAM (Simultaneous Localization and Mapping) using sonar measurements and a 6-axis IMU. The goal was to explore i2c, sensor drivers, sensor fusion, motion estimation, and simple mapping techniques from the ground up.
...
3. Educational exploration of Robotics concepts:
    ...
    This project serves as a platform to study the fundamentals of filtering, sensor fusion, motion estimation, and SLAM algorithms in a minimal, hardware-constrained environment.
...
**Note: If the legs of the cover are two tight you can cut them off if needed.**<br>
...
Yaw estimation relied solely on the gyroscope’s angular velocity, which contained significant noise and caused drift after integration. To address this, a median-based EMA filter was used along with a Zero-Velocity Update (ZVU), which zeros the angular rate when multiple consecutive readings fall below a defined threshold.

Stationary Values(Angular Velocity and Yaw Graphs):

<img src="assets/figures/stationary_filter_gz_500.png" alt="Stationary Velocity Values" width="49%"/>
<img src="assets/figures/stationary_filter_yaw_500.png" alt="Staionary Yaw Values" width="49%"/>

*The ZVU is responsible for zeroing out noise during stationary periods, as shown above.*

To evaluate the impact of filtering, the device was aligned to a paper template at multiple angles.

<img src="assets/figures/filter_gz_0_90.png" alt="Muliple Angle Velocity Values" width="49%"/>
<img src="assets/figures/filter_yaw_0_90.png" alt="Muliple AngleYaw Values" width="49%"/>
*The EMA filter works to reduce extreme values as shown in the left graph above, and the ZVU elimates drift as shown in the right graph above.*
...
<img src="assets/figures/filter_gz_0_90_30.png" alt="Muliple Angle Velocity Values" width="49%"/>
<img src="assets/figures/filter_yaw0_90_30.png" alt="Muliple AngleYaw Values" width="49%"/>
*After testing, the device maintained a consistent reading within one degree at each angle as shown in the top right graph.*